...
# ПРОДУВОЧНЫЙ ГАЗ (Purge): эстакада → врезка в ствол
route([
    (-9.0,      RY+0.30, PURGE_Z),  # 0: начало на эстакаде
    (0.0,       RY+0.30, PURGE_Z),  # 1: по эстакаде
    (FX+0.7,    FY,      PURGE_Z),  # 2: к стволу — врезка
    (FX,        FY,      PURGE_Z),  # 3: вход в ствол — joint в точке врезки
...
FS_X, FS_Y, FS_Z = -3.0, RY+0.30, PURGE_Z
cube((FS_X-0.08, FS_Y, FS_Z), (0.04, 0.06, 0.04), name="FlowS_Body", m=MS)
cyl((FS_X-0.08, FS_Y, FS_Z+0.07), 0.03, 0.06, name="FlowS_Top", m=MY, seg=10)
cyl((FS_X-0.08, FS_Y, FS_Z+0.12), 0.04, 0.02, name="FlowS_Head", m=MM, seg=12)
